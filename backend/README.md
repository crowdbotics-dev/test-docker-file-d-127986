...
## Project Structure
    ...
    ├── test_docker_file_d_127986  # Django project configurations
...
1. Clone this repo and `cd test_docker_file_d_127986`
...
2. Clone this repo and `cd test_docker_file_d_127986`
